/*
    This code is from the lecture to get you started with vector addition.
    You can ignore it but it was used as a reference to write the above code.
*/
...
/*
    Wrapper function for vector addition kernel.
    Can also be ignored as this is just for reference.
*/
